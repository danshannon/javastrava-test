...
public class AuthorisationServiceImplTest {
	...
	public void testTokenExchange_noScope() throws IOException, BadRequestException, UnauthorizedException {
		...
		Token tokenResponse = service.tokenExchange(TestUtils.STRAVA_APPLICATION_ID, TestUtils.STRAVA_CLIENT_SECRET, code);
	...
	public void testTokenExchange_viewPrivateScope() throws IOException, BadRequestException, UnauthorizedException {
		...
		// Perform the token exchange
		Token tokenResponse = service.tokenExchange(TestUtils.STRAVA_APPLICATION_ID, TestUtils.STRAVA_CLIENT_SECRET, code, AuthorisationScope.VIEW_PRIVATE);
		assertNotNull("Token not successfully returned by Strava", tokenResponse);
	...
	public void testTokenExchange_writeScope() throws IOException, BadRequestException, UnauthorizedException, NotFoundException {
		...
		// Perform the token exchange
		Token tokenResponse = service.tokenExchange(TestUtils.STRAVA_APPLICATION_ID, TestUtils.STRAVA_CLIENT_SECRET, code, AuthorisationScope.WRITE);
		assertNotNull("Token not successfully returned by Strava", tokenResponse);

		// test case to prove we've got write access
		ActivityService activityService = ActivityServiceImpl.instance(tokenResponse);
	...
	public void testTokenExchange_writeAndViewPrivateScope() throws IOException, BadRequestException, UnauthorizedException {
		...
		// Perform the token exchange
		Token tokenResponse = service.tokenExchange(TestUtils.STRAVA_APPLICATION_ID, TestUtils.STRAVA_CLIENT_SECRET, code, AuthorisationScope.VIEW_PRIVATE, AuthorisationScope.WRITE);
		assertNotNull("Token not successfully returned by Strava", tokenResponse);
	}
