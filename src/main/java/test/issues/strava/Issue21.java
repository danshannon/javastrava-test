...
import javastrava.api.v3.service.impl.retrofit.StreamServicesRetrofit;
...
public class Issue21 {
	...
	public void testIssue() throws UnauthorizedException, NotFoundException, BadRequestException {
		StreamServicesRetrofit retrofit = Retrofit.retrofit(StreamServicesRetrofit.class, TestUtils.getValidToken());
